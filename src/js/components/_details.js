        ...
        <div id="details">
            <ul class="unstyled">
                <li class="feels-like">
                    ...
                    <svg alt="" height="25" width="25" class="inline-icon svg-wi-thermometer"
                        data-temp="${Scales.fTempDataPt(
                            fClean(oCURRENT.app_temp)
                        )}"
                        enable-background="new 0 0 30 30" viewBox="0 0 30 30" xmlns="${sTempSvg}"/>
                    </svg>
                </li>
                ${
                    oCURRENT.uv
                        ? `<li class="uv-index">
                            ...
                            <svg alt="" height="25" width="25" class="inline-icon svg-wi-day-sunny"
                                data-uv="${Scales.fUvDataPt(
                                    fClean(oCURRENT.uv),
                                    _oSettings
                                )}"
                                enable-background="new 0 0 30 30" viewBox="0 0 30 30" xmlns="${sUvSvg}"/>
                            </svg>
                          </li>`
                        : ''
                }
                ...
                <li class="windspeed"><span class="left-col">
                    ...
                    <span class="inline-icon">
                        <svg alt="" height="25" width="25" class="compass"
                            style="transform: rotate(${sWindDeg}deg)"
                            enable-background="new 0 0 30 30" viewBox="0 0 30 30" xmlns="${sWindSvg}"/>
                        </svg>
                        ${oIcons.sWind}
                    </span>
